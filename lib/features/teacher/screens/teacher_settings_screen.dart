    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const Divider(),
          const _SectionHeader(title: 'QR Code Settings'),
          SwitchListTile(
            title: const Text('Auto-expire QR Codes'),
            subtitle: const Text('QR codes expire after class session ends'),
            secondary: Icon(
              Icons.qr_code,
              color: Theme.of(context).colorScheme.primary,
            ),
            value: true, // TODO: Implement QR settings provider
            onChanged: (bool value) {
          ...
          SwitchListTile(
            ...
            subtitle: const Text('Receive notifications about attendance'),
            secondary: Icon(
